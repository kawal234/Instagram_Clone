...
public final class FragmentAddBinding implements ViewBinding {
  ...
  private FragmentAddBinding(@NonNull LinearLayout rootView, @NonNull ImageView imageView2,
      @NonNull LinearLayout post, @NonNull LinearLayout reel, @NonNull TextView textView2) {
  ...
  public static FragmentAddBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAddBinding((LinearLayout) rootView, imageView2, post, reel, textView2);
    }
